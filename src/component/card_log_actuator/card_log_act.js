    ...
    <Flex alignItems="center" justifyContent="space-between" w={['100%']} direction={{ base: 'column', md: 'row' }}>
      <Flex>
        ...
        <Flex direction="column" alignItems="start" justifyContent="center">
          <Text>
            Status
{item.on_off_status == 1 ? (<Text width="100%" fontWeight="bold" color="var(--color-secondary-variant)">Nyala</Text>) : (<Text width="100%" fontWeight="bold" color="var(--color-error)">Mati</Text>)}
          </Text>
